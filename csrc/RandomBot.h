...
class RandomBot final : public Hanabi::Bot {
  ...
  public:
    RandomBot(int index, int numPlayers, int handSize);
    //RandomBot(int index, std::string filenamestr);
    ...
    //Move actionConversion(std::string filenamestr) const;
};
